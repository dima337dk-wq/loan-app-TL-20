...
export default class Home extends BasePage {
    ...
    readonly lastButton: Button;
    readonly amountInputScroll: Button;

    constructor(page: Page) {
        super(page, "/");
        this.amountInput = new Input(page, page.getByTestId("id-small-loan-calculator-field-amount"));
        this.amountInputScroll = new Button(page, page.getByTestId("id-small-loan-calculator-field-amount"));
        ...
        this.lastButton = new Button(page, page.getByTestId("id-image-element-button-image-2"))
